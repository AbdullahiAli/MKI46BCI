...
while ( endTest==0 )
  ...
  while ( endSeq==0 && endTest==0 )
    ...
    [data,devents,state]=buffer_waitData(buffhost,buffport,state,'startSet',{'stimulus.letter'},'trlen_ms',trlen_ms,'exitSet',{'data' {'stimulus.sequence' 'stimulus.feedback'} 'end'});
    numel(devents)
    ...
    for ei=1:numel(devents)
      ...
      elseif ( matchEvents(devents(ei),{'stimulus.letter'}) ) % flash, apply the classifier
